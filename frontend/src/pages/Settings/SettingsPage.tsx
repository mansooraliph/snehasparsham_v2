    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-text-muted">
          The portal's roles are fixed by design — each grants a default set of capabilities. Use Permission
          Grants below to give a specific user extra access beyond their role.
        </p>
      </div>
